    ...
    <StyledWrapper>
      <ul className="example-2">
        <li className="icon-content">
          <a href="https://www.linkedin.com/in/n-d-adithya-4959a0282/" aria-label="LinkedIn" data-social="linkedin" target='blank'>
        ...
        <li className="icon-content">
          <a href="https://github.com/adithya23-git" aria-label="GitHub" data-social="github" target='blank'>
            <div className="filled" />
        ...
        <li className="icon-content">
          <a href="https://www.instagram.com/adhi_adithya_123?igsh=MThrM2V6NTJsMDA2aw==" aria-label="Instagram" data-social="instagram" target='blank'>
            <div className="filled" />
